...
nvcc --compiler-options -std=c++14 -c -o snnfc_kernels.cu.o snnfc_kernels.cu.cc ${TF_CFLAGS[@]} \
...
g++ -std=c++14 -shared -o snnfc_ops.so snnfc_kernels.cc snnfc.h snnfc_ops.cc snnfc_kernels.cu.o \
