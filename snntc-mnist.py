...
class MyModel(tf.keras.Model):
    def __init__(self, weight_k=100, weight_k2=1e-2):
        ...
        self.layer1 = SNN.SNN_conv(kernel_sizes=3, in_channel=1, out_channel=32, strides=2)
        self.layer2 = SNN.SNN_conv(kernel_sizes=3, in_channel=32, out_channel=64, strides=2)
...
for epoch in range(EPOCHS):
    ...
    print(' average: Train (loss, acc) = (', str(train_loss[-1])[:6], ', ', str(train_acc[-1])[:6],
